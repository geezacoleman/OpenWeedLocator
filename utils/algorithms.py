...
# located here are image processing algorithms for weed detection, blur algorithms are located below.
...
'''
These algorithms are used in calculating image blur for focusing and in video processing for the publication:
https://www.sciencedirect.com/science/article/pii/S0168169923008074
'''
